  ...
  return (<BottomScreen onClose={onClose} autoHeight>
      <View style={styles.cont}>
        ...
        <Card style={styles.status}>
          <Text style={[ styles.status__left, status ? styles.status__left_done : undefined ]} type="light">
            {status ? 'Выполнен' : 'Готовится'}
          </Text>
          <Text style={styles.status__right} type="light">Доставка через ~{deliveryTime} минут</Text>
        </Card>
        ...
        <View style={styles.summary}>
          <View style={styles.summary__row}>
            <Text style={styles.summary__row__title} type="light">Бонусы за заказ</Text>
            <Text style={styles.summary__row__value} ype="bold">{summary.bonuses} бонусов</Text>
          </View>
          <View style={styles.summary__row}>
            <Text style={styles.summary__row__title} type="light">Сумма заказа</Text>
            <Text style={styles.summary__row__value} ype="bold">{summary.price} ₽</Text>
          </View>
          <View style={styles.summary__row}>
            <Text style={styles.summary__row__title} type="light">Стоимость доставки</Text>
            <Text style={styles.summary__row__value} ype="bold">
              {summary.delivery === 0 ? 'Бесплатно' : summary.delivery}
            </Text>
          </View>
          <View style={styles.summary__row}>
            <Text style={styles.summary__row__title} type="light">Персональная скидка</Text>
            <Text style={styles.summary__row__value} ype="bold">{summary.sale} ₽</Text>
          </View>
          <View style={styles.summary__row}>
            <Text style={styles.summary__row__title} type="light">Итого</Text>
